...
<section class="user d-flex flex-wrap align-items-center justify-items-center m-auto">
    <figure class="d-flex flex-wrap m-auto justify-content-center">
        <img class="img-prevent-drag " src="<?= $BASE ?>/<?=imgOrDefault('users',$user->img, $user->id)?>" title="<?= $user->name ?>" onerror="this.onerror=null;this.src='<?=$BASE?>/public/img/not_found/no_image.jpg';">
