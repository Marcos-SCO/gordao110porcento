  ...
  <div class="owlDefaultItem owl-carousel owl-theme" data-js="owlDefaultItem" modal-item-container>
    ...
    ?>
      <a <?= (detectIE() != true) ? 'data-toggle="modal" data-target="#itemModal"' : "href='$BASE/products/show/$pizzaItemId'" ?> id="product_<?= $pizzaItemId ?>" modal-item>
        ...
        <figure class="item">
          <img class="mx-auto" src="<?= $BASE_WITH_PUBLIC ?>/<?= imgOrDefault('products',$pizzaItemImg, $pizzaItemId, "/category_$pizzaItemIdCategory") ?>" alt="<?=$pizzaItemImg ?>" title="<?= $pizzaItemProductName ?>" onerror="this.onerror=null;this.src='<?= $RESOURCES_PATH ?>/img/not_found/no_image.jpg';" loading="lazy" width="246" height="184">
