  ...
  <div class="owlDefaultItem owl-carousel owl-theme" data-js="owlDefaultItem" modal-item-container>
    ...
    ?>
      <a <?= (detectIE() != true) ? 'data-toggle="modal" data-target="#itemModal"' : "href='$BASE/products/show/$hamburgerItemId'" ?> id="product_<?= $hamburgerItemId ?>" modal-item>
        ...
        <figure class="item">
          <img class="mx-auto" src="<?= $BASE_WITH_PUBLIC ?>/<?= imgOrDefault('products', $hamburgerImg, $hamburgerItemId, "/category_$hamburgerItemIdCategory") ?>" alt="<?= $hamburgerImg ?>" title="<?= $hamburgerProductName ?>" onerror="this.onerror=null;this.src='<?= $RESOURCES_PATH ?>/img/not_found/no_image.jpg';" loading="lazy" width="246" height="184">
