    ...
    <section class="about">
        <figure>
            ...
            <figcaption>
                ...
                <p>Somos uma lanchonete e restaurante com mais de <span class="activeYears link">vinte e três</span> anos de tradição. Já servimos todo tipo de refeição com nosso extenso <span class="link" id="menu">menu</span>, <a href='<?= $PHONE_NUMBER_NUMBER_LINK ?>'>peça já!.</a> Te convidamos a se deliciar com nossas ofertas. Você terá a satisfação a 110% e garantia de qualidade. É gordão ou nada!
            </figcaption>
        </figure>
